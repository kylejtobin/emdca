...
| :--- | :--- | :--- |
| **"The Agent"** | **[Pattern 09: State Machine](patterns/09-workflow-state-machine.md)** | An Agent is a state machine where transitions use an LLM instead of `if/else`. **Smart Enums** define the lifecycle graph. |
...
| **"Configuration"** | **[Pattern 10: Capability as Data](patterns/10-infrastructure-capability-as-data.md)** | System Prompt, Model Name, Temperature are capability models (Data). |
